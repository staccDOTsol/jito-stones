...
pub mod convert_to {
    ...
    pub fn create_transaction_meta(meta: &TransactionStatusMeta) -> proto::TransactionStatusMeta {
        ...
        let loaded_writable_addresses = create_pubkeys(&loaded_addresses.writable.as_slice());
        let loaded_readonly_addresses = create_pubkeys(&loaded_addresses.readonly.as_slice());
